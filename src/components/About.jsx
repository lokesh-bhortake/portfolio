        ...
        <section id="about" className="text-accent gap-8 py-2">
            <div className="flex gap-8 items-center">
                <div className={`flex flex-col ${styles.sizeFull} gap-8 p-4`}>
                    ...
                    <a
                        href="#contact"
                        className={`${styles.filledButton} md:w-[50%] text-center`}
                    >
                        Hire Me
                    </a>
                </div>
            ...
            <div className="relative items-center">
                <div
                    className={`sm:hidden md:left-[25%] lg:left-[30%] layer-blur ${styles.blurDiv}`}
                ></div>
            </div>

            <div
                className={`${styles.flexCenter} flex-col gap-8 py-20 sm:py-16 md:py-6`}
            >
                <h3 className="text-h3 font-bold">Skills</h3>
                <ul
                    className={`${styles.flexCenter} flex-wrap gap-x-6 gap-y-8 py-4 px-2`}
                >
                    {skills.map((skill, index) => (
                        <li
                            key={index}
                            className={`${styles.flexCenter} flex-col gap-4 px-4 py-2`}
                        >
                            <img
                                src={skill.icon}
                                alt={skill.text}
